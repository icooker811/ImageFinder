...
public class InterestPoint {
    ...
    public String toString() {
        ...
        if (!file.contains("input.txt")) {

            f.format("1 %12f %12f %12f %12f %12f %12f ", x, y, strength, trace, scale, orientation);
    ...
    public static void saveToFile1(List<InterestPoint> ipts, String fileName, boolean inclDescriptor) {
        System.out.print("dd");
        try {
    ...
    public static String messageToFile(List<InterestPoint> ipts, String fileName,boolean inclDescriptor) {
        String message = "";
        file = fileName;
        if (ipts != null && ipts.size() > 0) {
