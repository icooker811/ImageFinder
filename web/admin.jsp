<%-- 
    Document   : home
    Created on : 13 ต.ค. 2555, 2:16:31
    Author     : TUK
--%>
...
<frameset rows="*" cols="313,1*" frameborder="no" border="0" framespacing="0">
  <frame src="tabmenu2.jsp" name="leftFrame" scrolling="No" noresize="noresize" id="leftFrame" title="leftFrame" />
