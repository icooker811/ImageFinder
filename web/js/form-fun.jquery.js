...
$(function(){
	...
	$("#num_attendees").val('Please Choose');
        $("#num2_attendees").val('Please Choose');
	...
	// When a 1 dropdown selection is made
	$("#num_attendees").change(function() {
        ...
        // When a 2 dropdown selection is made
	$("#num2_attendees").change(function() {

		$(".name2_wrap").slideUp().find("input").removeClass("active_name_field");
		
		switch ($("#num2_attendees option:selected").text()) {
			case '1':
				$("#attendee2_1_wrap").slideDown().find("input").addClass("active_name_field");
				break;
			case '2':
				$("#attendee2_1_wrap").slideDown().find("input").addClass("active_name_field");
				$("#attendee2_2_wrap").slideDown().find("input").addClass("active_name_field");
				break;
			case '3':
				$("#attendee2_1_wrap").slideDown().find("input").addClass("active_name_field");
				$("#attendee2_2_wrap").slideDown().find("input").addClass("active_name_field");
				$("#attendee2_3_wrap").slideDown().find("input").addClass("active_name_field");
				break;
			case '4':
				$("#attendee2_1_wrap").slideDown().find("input").addClass("active_name_field");
				$("#attendee2_2_wrap").slideDown().find("input").addClass("active_name_field");
				$("#attendee2_3_wrap").slideDown().find("input").addClass("active_name_field");
				$("#attendee2_4_wrap").slideDown().find("input").addClass("active_name_field");
				break;
			case '5':	
				$("#attendee2_1_wrap").slideDown().find("input").addClass("active_name_field");
				$("#attendee2_2_wrap").slideDown().find("input").addClass("active_name_field");
				$("#attendee2_3_wrap").slideDown().find("input").addClass("active_name_field");
				$("#attendee2_4_wrap").slideDown().find("input").addClass("active_name_field");
				$("#attendee2_5_wrap").slideDown().find("input").addClass("active_name_field");
				break;
			}
                      //  stepTwoTest();
	});
	...
	*/
	$("#rock").click(function(){
		if (this.checked && $("#num_attendees option:selected").text() != 'Please Choose'
		  	&& $("#num2_attendees option:selected").text() != 'Please Choose') {
                        /*	if (this.checked && $("#num_attendees option:selected").text() != 'Please Choose'
