    ...
    <body >
        <div data-role="header">
           <h1>CPE CMU Matching</h1>
            <a href="lookup-loc.jsp?mapid=<% out.print(request.getParameter("mapid"));%>" data-icon="back">Back</a>
            <a href="index.jsp" data-icon="home">Home</a>
        </div>

        <div data-role="content" >
            <h2 id="list-inset">Look Up</h2>
            <p>3. Choose your destination</p>
            ...
            <div data-demo-html="true">
                ...
                String sql = "select polygonid,detail from polygon where mapid ='" + request.getParameter("mapid") + "' ";
                            ...
                            while (myresult.next()) {
                                ...
                                out.println("<li><a href=\"lookup-direction.jsp?mapid=" + request.getParameter("mapid") + "&loc=" + request.getParameter("loc") + "&des=" + myresult.getString("polygonid") + "\"><img style=\"margin-left:10px;\" width=\"100px\" height=\"100px\"src=\"../images/marker_2.png\">  <h1 class=\"Header\">" + myresult.getString("polygonid") + "</h1><p class=\"Paragraph \">" + myresult.getString("detail") + "</p> </a></li>");
